...
public class Gasolinera
{
    ...
    public int venderGasolinaPorPrecio( String nombreTipoGasolina, int valorSolicitado, int numeroSurtidor )
    {
        ...
        boolean gasolinaSuficiente = true;
        ...
        surtidor.venderGasolina( nombreTipoGasolina, cantidadEntregada );
       
        if( gasolinaSuficiente )
            return valorSolicitado;
        else
            return (int)( cantidadEntregada * tipo.getPrecioPorGalon() );
    }
